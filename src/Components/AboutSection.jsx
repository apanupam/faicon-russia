      ...
      <section className="py-16 px-8 bg-white">
        <div className="container mx-auto py-4">
          ...
          <div className="grid grid-cols-5 gap-8 ">
            <div className="col-span-3 relative z-1 py-15 px-12 rounded-s rounded-md">
              <div className="">
            ...
            <div className="col-span-2 relative z-1 flex flex-col justify-end py-15 px-12 rounded-s rounded-md">
              <div className="h-fit">
