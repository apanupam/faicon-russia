      ...
      <section className="py-16 px-8 bg-white">
        <div className="container mx-auto py-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#091F5B] mb-4">Flexible services for every stage of your business</h2>
            <p className="text-sm sm:text-md text-[#444444] font-normal max-w-4xl mx-auto mb-7">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 ">
            <div className="col-span-2 lg:col-span-3 relative z-1 py-15 px-12 rounded-md overflow-hidden group">
              <div className="">
            ...
            <div className="col-span-2 lg:col-span-2 relative z-1 flex flex-col group justify-end py-15 px-12 overflow-hidden rounded-md">
              <div className="h-fit">
